<template>
  <div class="register-container">
    ...
    <form @submit.prevent="handleRegister">
      ...
      <p>If you use the username **'admin'**, you will be registered as an **Archivist**.</p>
  ...
  methods: {
    async handleRegister() {
      ...
      try {
        ...
        this.error = true;
        this.message = err.response ? err.response.data.message : 'Registration failed. Server error.';
        console.error(err);
      }
    },
  },
